		...
		<div class="modal-content">
			...
			<form action="/aluno/mensagem/enviar" method="post">
				<div class="modal-body">
					...
					<div class="form-group">
						<input autocomplete="off" class="form-control tituloObrigatorio" type="text" id="titulo" maxlength="100" name="titulo" placeholder="Titulo">
					</div>
					<div class="form-group">
							...
							<div class="col-md-3 col-sm-4">
								...
								<div style="margin-top: 15px;">
									<ul class="nav nav-pills nav-stacked">
										...
										@if($count==0)
										<li class=""><a href="/aluno/mensagens/entrada"><i class="fa fa-inbox"></i> Entrada</a></li>
										@else
										<li class=""><a href="/aluno/mensagens/entrada"><i class="fa fa-inbox"></i> Entrada ({{$count}})</a></li>
										@endif
										<li class="active"><a href="/aluno/mensagens/enviados"><i class="fa fa-mail-forward"></i> Enviados</a></li>
									</ul>
								</div>
							</div> 
