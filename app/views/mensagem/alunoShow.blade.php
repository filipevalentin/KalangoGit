	...
	<div id="anteriores" style="display: none;">
		<div class="">
			<div class="mailbox-read-info" style="padding:10px;">
				<h3>{{$re->titulo}}</h3>
				<h5>De: {{$re->usuarioOrigem->nome}} {{$re->usuarioOrigem->sobrenome}}<span class="mailbox-read-time pull-right">{{ date('d/m/Y h:i', strtotime(str_replace('-','/', $re->data)))}}</span></h5><hr>
