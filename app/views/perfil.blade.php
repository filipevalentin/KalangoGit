                        ...
                        <div class="tab-content no-border padding-24 profile">
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-sm-3 center" style="text-align: center">  <!-- FotoPerfil+Botões -->
                                        <span class="profile-picture">
                                            <img class="editable img-responsive" alt="Alex's Avatar" id="avatar2" style="height: 200px;" {{'src="'.Aluno::find(Auth::user()->id)->urlImagem.'"'}} >
                                        </span>
                            ...
                            <div id="editar" class="tab-pane"> <!-- Aba "editar" -->
                                <div id="edit-basic" class="tab-pane active">
                                    {{ Form::open(array('url'=>'atualizaCadastro', 'files'=>true)) }}
