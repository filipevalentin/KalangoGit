            ...
            <div class="modal-body">
                ...
                <form method="POST" action="/admin/atualizarRespostaUnica" id="form" enctype="multipart/form-data">
                    ...
                    <div id="div_texto-dissertativa-editar-questao" class="form-group">
                        ...
                        <textarea id="enunciado" name="enunciado" maxlength="8000" onblur="fcn_recarregaCoresDissertativaEditarQuestao();" class="form-control enunciadoObrigatoria-dissertativa-editar-questao" rows="3"></textarea>
                    </div>
                    <div class="form-group">
                        <label class="control-label" for="arquivo"><i class="fa"></i> Arquivo</label>
            ...
            <div class="modal-body">
                ...
                <form method="POST" action="/admin/criarQuestaoME" id="formme" style="display:none;" enctype="multipart/form-data">
                    ...
                    <div id="div_texto-multipla-nova-questao" class="form-group">
                        ...
                        <input id="enunciado" name="enunciado" maxlength="8000" onblur="fcn_recarregaCoresMultiplaNovaQuestao();" class="form-control enunciadoObrigatoria-multipla-nova-questao" rows="3" >
                    </div>
                                ...
                                <div class="panel box box-primary ui-sortable-handle">
                                    <div class="box-header">
                                        ...
                                        <div class="box-tools pull-right">
                                            ...
                                            <a href="/admin/questao/deletar/{{$questao->id}}"><button class="btn btn-danger btn-xs"><i class="fa fa-times"></i></button></a>                                        </div>
