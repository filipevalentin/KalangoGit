            ...
            <div class="modal-body">
                ...
                <form method="POST" action="/admin/criarQuestaoME" id="formme" style="display:none;" enctype="multipart/form-data">
                    ...
                    <div id="div_texto-multipla-nova-questao" class="form-group">
                        ...
                        <input id="enunciado" name="enunciado" maxlength="8000" onblur="fcn_recarregaCoresMultiplaNovaQuestao();" class="form-control enunciadoObrigatoria-multipla-nova-questao">
                    </div>
                ...
                <form action="/admin/criarQuestaoRU" method="POST" id="formru" style="display:none;" enctype="multipart/form-data">
                    ...
                    <div id="div_texto-dissertativa-nova-questao" class="form-group">
                        ...
                        <input id="enunciado" name="enunciado" maxlength="8000" onblur="fcn_recarregaCoresDissertativaNovaQuestao();" class="form-control enunciadoObrigatoria-dissertativa-nova-questao" rows="3" >
                    </div>
                                ...
                                <div class="panel box box-primary ui-sortable-handle">
                                    <div class="box-header">
                                        ...
                                        @if(substr($questao->categoria,1) == "4")
                                            <small class="badge pull-right bg-red" style="margin: 0px 6px 0px 5px;"><i class="fa fa-microphone"></i>Rec. de Voz</small>
                                        @endif
                                        <small class="badge pull-right bg-green" style="margin: 0px 6px 0px 5px;"><?php if($questao->topico->nome != null) echo $questao->topico->nome ?></small>
		                                        	<small class="badge pull-right bg-red" style="margin: 0px 6px 0px 5px;"><?php if($questao->pontos != null) echo $questao->pontos ?> pontos</small>
                                    </div>
