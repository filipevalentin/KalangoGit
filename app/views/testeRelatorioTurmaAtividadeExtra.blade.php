	        ...
	        @foreach($alunos as $aluno)
		        <div class="box box-solid" style="padding: 2% 3%;">
		        	...
		        	<div class="box-header with-border">
		        		...
		        		<div class="col-sm-3">
		        			<strong>Média Geral:</strong> <span style="padding-right:20px;"></span>
		        		</div>
		        		<div class="col-sm-3">
		        	...
		        	<div class="box-body">
		        		<ul class="list-unstyled">
		        			@foreach($aluno->categoriasAluno as $categoria)
			        			<li>
			        				<span><strong>{{$categoria->titulo}}</strong></span>
			        				<div class="pull-right">
			        					<span style="padding-right:20px;"><strong>Média:</strong> {{round($categoria->media*10,1)}}/10 </span>
			        					<span> <strong>Presença:</strong>  {{round($categoria->presenca*100,2)}}%</span>
			        				</div>
