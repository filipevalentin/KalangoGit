                    ...
                    <div id="my-tab-content" class="tab-content">
                        ...
                        <div class="tab-pane active" id="login">
                            ...
                            <form class="form-signin" action="" method="POST">
                                <input type="text" autocomplete="off" class="form-control" placeholder="Usuário" name="usuario" required="" autofocus="">
                        ...
                        <div class="tab-pane" id="esqueci">
                            ...
                            <form class="form-signin" action="{{ action('RemindersController@postRemind') }}" method="POST">
                                <input class="form-control" type="email" autocomplete="off" name="email" placeholder="E-mail" required>
