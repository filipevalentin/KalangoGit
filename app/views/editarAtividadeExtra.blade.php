            ...
            <div class="col-md-8">
                <div class="box box-solid">
                    <div class="box-header">
                        <h3 class="box-title">{{$atividadeExtra->nome}}</h3>
                        <div class="box-tools pull-right" style="padding: 10px 20px 5px 5px;">
                            <button class="btn btn-primary btn-md" style="border-radius: 50px;" data-toggle="modal" data-target="#criarquestao" data-idexercicio="{{$atividadeExtra->id}}"><i class="fa fa-plus"></i></button>
                        </div>
                    </div><!-- /.box-header -->
                    <div class="box-body">
                        <div class="box-group connectedSortable ui-sortable" id="accordion">
                        <?php $aux = 1;
                            $questoes = $atividadeExtra->questoesRU->combine($atividadeExtra->questoesME)->sortBy('numero');
                        ?>
                                            ...
                                            <div class="row" style="margin:0px;">
                                                <div class="box text-center">
                                                    ...
                                                    @elseif(substr($categoria, 0, 1)==3)
                                                        <div>Sem suporte para audio ainda :/</div>
                                                    @endif
