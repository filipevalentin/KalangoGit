                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="box-body">
                                                <div class="small-box bg-blue">
                                                    <div class="inner">
                                                        <a href="/professorModuloViewTurma/{{$turma->modulo->id}}/{{$turma->id}}" style="color: inherit;" class="turma">
                                                    ...
                                                    <a href="/professorTurmaView/{{$turma->id}}" class="small-box-footer">Ver Alunos <i class="fa fa-arrow-circle-right"></i></a>
                                                </div>
                                            </div>
                                        </div>
