...
function PDFViewerPlugin() {
    ...
    function init(callback) {
        ...
        loadScript('/ViewerJS/compatibility.js', function () {
            loadScript('/ViewerJS/pdf.js');
            loadScript('/ViewerJS/ui_utils.js');
            loadScript('/ViewerJS/text_layer_builder.js');
            loadScript('/ViewerJS/pdfjsversion.js', callback);
        });

        pluginCSS = document.createElement('link');
        pluginCSS.setAttribute("rel", "stylesheet");
        pluginCSS.setAttribute("type", "text/css");
        pluginCSS.setAttribute("href", "/ViewerJS/PDFViewerPlugin.css");
